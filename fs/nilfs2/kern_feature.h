...
#endif
/*
 * Some inode operations and helpers were changed in kernel 6.3 to
 * pass struct mnt_idmap instead of struct user_namespace.
 */
#ifndef HAVE_USER_NAMESPACE_ARGS
# define HAVE_USER_NAMESPACE_ARGS \
